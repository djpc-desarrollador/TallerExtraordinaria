...
namespace Software
{
    public partial class VistaTipoAsociados : Form
    {
        ...
        private NTipoAsociado negocio;
        private TipoAsociado seleccion;
        private List<TipoAsociado> registros;
        ...
        private void buttonActualizar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    TipoAsociado entidad = this.ArmarEntidad();
        ...
        private void buttonSeleccionar_Click(object sender, EventArgs e)
        {
            ...
            {
                TipoAsociado entidad = ArmarEntidad();
                List<TipoAsociado> resultados = negocio.Buscar(entidad);
        ...
        private TipoAsociado ArmarEntidad()
        {
            // Extraer los  
            ...
            return new TipoAsociado() { Id = codigo, Descripcion = descripcion };
        }
        ...
        private void CargarRegistros(List<TipoAsociado> registros)
        {
            this.registros = registros;
            this.dataGridViewRegistros.DataSource = registros;
            this.dataGridViewRegistros.Columns.Remove("Eliminado");
            this.dataGridViewRegistros.Columns.Remove("Asociado");
